...
export async function getServerSideProps(context){
    ...
    const res = await fetch(
        `https://api.openweathermap.org/data/2.5/onecall?lat=${city.coord.lat}&lon=${city.coord.lon}&appid=7b26c92417fd3678d52eac12dc870222&exclude=minutely&units=metric`
      );    
